...
import 'package:travel/features/destination/presentation/widget/top_destination_image.dart';
...
class _HomePageState extends State<HomePage> {
        ...
        children: [
          Container(
            ...
            child: const CircleAvatar(
              radius: 16,
              backgroundImage: AssetImage('assets/lyney.jpeg'),
            ),
          ),
  ...
  Widget itemAllDestination(DestinationEntity destination) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          print('masuk detail page ${destination.name}');
          Navigator.pushNamed(context, AppRoute.detailDestination,
              arguments: destination);
        },
        child: Row(
